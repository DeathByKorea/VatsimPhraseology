...
namespace VATSIMControllinggenerator {
    internal static class Program {
        ...
        private static void Clearance() {
            ...
            switch (choice) {
                case "1":
                    WriteLine($"{callsign} You are cleared to the {airport} airport via the {sid} departure, {trans} transition. Then as filed. \n Climb via SID, maintain {inital}, expect {alt} one zero minutes after departure. \n Departure frequency {freq}. Sqwark {sqwark}.");
                    break;
                case "2":
                    WriteLine($"{callsign} You are cleared to the {airport} airport. Radar vectors {sid}. Then as filed. \n Maintain {inital}, expect {alt} one zero minutes after departure. \n Departure frequency {freq}. Sqwark {sqwark}.");
                    break;
                case "3":
                    WriteLine($"{callsign} Maintain VFR at or below {alt} Departure frequency {freq}, Sqwark {sqwark}.");
                    break;
                case "4":
                    WriteLine($"{callsign} Maintain VFR at or below {alt}. Sqwark {sqwark}.");
                    break;
                case "5":
                    WriteLine($"{callsign} Readback correct. Push and start at your discresion. Expect runway {rwy} for departure. Altimeter {baro}.");
                    break;
                case "6":
                    WriteLine($"{callsign} Readback correct. Push and start at your discresion. Expect runway {rwy} for departure. ATIS Information {atis} current.");
                    break;
                case "7":
                    WriteLine($"{callsign} Readback correct. Push and start at your discresion. Expect runway {rwy} for departure.");
                    break;
                default:
                    WriteLine("Invalid argument.");
                    Thread.Sleep(2000);
        ...
        private static void Ground() {
            ...
            switch (choice) {
                case "1":
                    ...
                    break;
                case "2":
                    WriteLine($"{callsign} Runway {rwy} Taxi via {route}, Hold short of {hold} (Add hold short instructions as needed.)");
                    break;
                default: 
                    WriteLine("Invalid Argument");
                    Thread.Sleep(2000);
        ...
        private static void Tower() {
            ...
            switch (choice) {
                ...
                case "2":
                    ...
                    break;
                case "3":
                    WriteLine($"{callsign}, After departure fly heading {heading}, Winds {winds}, Runway {rwy}, Cleared for takeoff.");
                    break;
                case "4":
